...
var DeviceTypesMapeltex = map[string]*DeviceData{
    ...
    "WLC-3200": {
        ...
        Interfaces: []Interface{
            { Name: "twentyfivegigabitethernet 1/0/1", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/2", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/3", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/4", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/5", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/6", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/7", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/8", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/9", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/10", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/11", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "twentyfivegigabitethernet 1/0/12", Label: "", Type: "25gbase-x-sfp28", MgmtOnly: false },
            { Name: "oob 1/0/1", Label: "", Type: "1000base-t", MgmtOnly: true },
        },
    },
    "WLC-HW-50": {
        Manufacturer: "Eltex",
