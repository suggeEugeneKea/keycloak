...
var DeviceTypesMapippon = map[string]*DeviceData{
    ...
    "Innova RT II 1000": {
        Manufacturer: "Ippon",
        Model: "Innova RT II 1000",
        Slug: "ippon-innova-rt-ii-1000",
        UHeight: 2,
        PartNumber: "1398359",
        IsFullDepth: true,
        Airflow: "front-to-rear",
        ...
        PowerPorts: []PowerPort{
            { Name: "Inlet", Label: "", Type: "iec-60320-c14", MaximumDraw: 1000, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
            { Name: "Outlet 1", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "Outlet 2", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
    ...
    "Innova RT II 2000": {
        Manufacturer: "Ippon",
        Model: "Innova RT II 2000",
        Slug: "ippon-innova-rt-ii-2000",
        UHeight: 2,
        PartNumber: "1398362",
        IsFullDepth: true,
        Airflow: "front-to-rear",
        ...
        PowerPorts: []PowerPort{
            { Name: "Inlet", Label: "", Type: "iec-60320-c14", MaximumDraw: 2000, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
            { Name: "Outlet 1", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "Outlet 2", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
    ...
    "Innova RT II 3000": {
        Manufacturer: "Ippon",
        Model: "Innova RT II 3000",
        Slug: "ippon-innova-rt-ii-3000",
        UHeight: 2,
        PartNumber: "1398366",
        IsFullDepth: true,
        Airflow: "front-to-rear",
        ...
        PowerPorts: []PowerPort{
            { Name: "Inlet", Label: "", Type: "iec-60320-c20", MaximumDraw: 3600, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
            { Name: "Outlet 1", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "Outlet 2", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            ...
            { Name: "Outlet 7", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "Outlet 8", Type: "iec-60320-c13", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "Outlet 16A", Type: "iec-60320-c19", Label: "", PowerPort: "Inlet", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
        },
        FrontPorts: []FrontPort{
        },
        RearPorts: []RearPort{
